...
if (typeof usi_js === 'undefined') {
	usi_js = {
		campaign: {
			id: '9891781723451274327377',
			site_id: 48449,
			original_site_id: 48449,
			config_id: 96125,
			company_id: 5698,
			key: 'desktop_english',
			link: '',
			deep_link: 'https://shutterstock.7eer.net/c/16669/42913/1305?sharedid=Free%20Trial%20-%20Flex%20Generic&url=',
			domains: '',
		...
		display_vars: {
			...
			bottom: '',
			mobilefit: 0,
			background: "/chatskins/5698/Shutterstock-TT-1-23-dsktp-images.jpg",
			p1: "",
			p2: "",
			intrinsic_size: {
				background: {
...
if (usi_js.campaign.site_id === 47641) {
  usi_js.campaign.deep_link = "https://shutterstock.7eer.net/c/16669/42913/1305?sharedid=Free%20Trial%20-%20Get%2010%20Free%20Images&url=";
}
...
usi_js.display_vars.p1_html = [
	'<div class="usi_sr_only">shutterstock flex. Get 10 free images now. Try the all-in-one plan for free. Pay just $29/mo after your trial ends. If you cancel in the first month you pay nothing!</div>',
	...
	'<button class="usi_submitbutton" onclick="usi_js.click_cta();" type="button" aria-label="Start Your Free Trial"></button>',
].join('');
