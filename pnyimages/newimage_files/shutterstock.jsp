...
if (typeof usi_analytics === 'undefined') {
	...
	usi_aff = {
				...
				if (!usi_app.suppress_page) {
					...
					if ((usi_app.get_user_status("user").status == "guest" || usi_app.get_user_status("user").isActive == "false") && ((/.shutterstock.com\/image-generated|.shutterstock.com\/ai-image-generator|.shutterstock.com\/generate/i).test(location.href) || checkout_ai_eligible) && (language_key == "_english")) {
						...
						if (usi_split_test.get_group('47807') == '1') {
							return usi_commons.load_view("hlYEQoU945VqaJepXY0YGEz", "47805", usi_commons.device);
						} else {
							return usi_commons.log("USI Lift Test: Control");
						}
					}
					...
					if (usi_app.is_image_page || usi_app.is_image_in_cart) {
						var threshold = 0;
						if (usi_app.check_sub_total_price(threshold) && (usi_app.is_flexable || (usi_app.is_checkout_page && checkout != null && (checkout.textContent.trim().indexOf("FLEX 10") != -1 || checkout.textContent.trim().indexOf("5 Credit Pack") != -1 || checkout.textContent.trim().indexOf("2 Credit Pack") != -1)))) {
							...
							if (Math.random() > .5) {
								...
								usi_commons.log("[USI] LOAD 48251")
								usi_commons.load_view("cPrFBqwQp0bKjV4FSKKB3Ah", "48251", usi_commons.device + language_key);
							} else {
								usi_app.flex_destination_url = "https://www.shutterstock.com/explore/flex-subscriptions";
								usi_commons.log("[USI] LOAD 48449")
								usi_commons.load_view("qyTOCcCE1C4jvnOUvnLvlff", "48449", usi_commons.device + language_key);
							}
						} else {

							if(usi_date.is_between('2023-09-05T00:00:00-07:00','2023-09-18T20:59:00-07:00')) {
									usi_app.lookup({
										ids: window.customerId || '',
										list: "lapsed",
										match: "any",
										callback: function (found, options) {
											if (usi_app.is_enabled && found == 1 || usi_commons.gup_or_get_cookie('usi_force_lapsed')) {
												// ID was found in list
												usi_commons.log("usi_app.lookup: customer_id found in lapsed user list");

												usi_app.messaging = usi_app.get_messaging('sitewide_event_q3_2023_lapsed_users');
												usi_commons.log("[USI] 48501 Sitewide Event 30% Off Lapsed Users [IMAGES] :: " + usi_commons.device + language_key)
												usi_commons.load_view("q3oQK9ugwkTUEU1Ne3bwxo8", "48501", usi_commons.device + language_key);
											} else {
												usi_app.messaging = usi_app.get_messaging('sitewide_event_q3_2023_new_users');
												usi_commons.log("[USI] 48481 Sitewide Event 20% Off New Users [IMAGES] :: " + usi_commons.device + language_key)
												usi_commons.load_view("g2eLwgIUNCTJT6bvcS61tb5", "48481", usi_commons.device + language_key);
											}
										}
									});
								} else {
							...
							usi_app.lookup({
								...
								callback: function (found, options) {
									if (usi_app.is_enabled && found == 1 || usi_commons.gup_or_get_cookie('usi_force_lapsed')) {
										...
										usi_app.messaging = usi_app.get_messaging('sitewide_event_q3_2023_lapsed_users');
										usi_commons.log("[USI] 48503 Sitewide Event 30% Off Lapsed Users [VIDEO] :: " + usi_commons.device + language_key)
										usi_commons.load_view("hJke7UaeGtnLsy8iCW8oGHh", "48503", usi_commons.device + language_key);
									} else {
										usi_app.messaging = usi_app.get_messaging('sitewide_event_q3_2023_new_users');
										usi_commons.log("[USI] 48489 Sitewide Event 20% Off New Users [VIDEO] :: " + usi_commons.device + language_key)
										usi_commons.load_view("COgvIAZ7w33aH2OEE1bJX79", "48489", usi_commons.device + language_key);
									}
								}
							});
						} else {
								...
								usi_app.lookup({
									...
									callback: function (found, options) {
										if (usi_app.is_enabled && found == 1 || usi_commons.gup_or_get_cookie('usi_force_lapsed')) {
											...
											usi_app.messaging = usi_app.get_messaging('sitewide_event_q3_2023_lapsed_users');
											usi_commons.log("[USI] 48505 Sitewide Event 30% Off Lapsed Users [MUSIC] :: " + usi_commons.device + language_key)
											usi_commons.load_view("fn4TSecYd7a94MMvcmfsGHt", "48505", usi_commons.device + language_key);
										} else {
											usi_app.messaging = usi_app.get_messaging('sitewide_event_q3_2023_new_users');
											usi_commons.log("[USI] 48481 Sitewide Event 20% Off New Users [MUSIC] :: " + usi_commons.device + language_key)
											usi_commons.load_view("juGiZvC0851cJdjSacG1xq9", "48491", usi_commons.device + language_key);
										}
									}
								});
							} else {
		...
		usi_app.get_messaging = function(campaign) {
			...
			if(campaign == 'sitewide_event_q3_2023_new_users') {
		...
		usi_app.message_sitewide_event_q3_2023_new_users = {
			"english": {header1:"Unleash your creativity",header2:"Get 20% off your order today", header3: "", css:".usi_header1{font-size: 2.5em !important;} .usi_header2{font-size: 2.5em !important;}", css_mobile: '',  use_code:"",cta:"Redeem Now", disclaimer:"We use your information in accordance with our privacy policy."},
		...
		usi_app.message_sitewide_event_q3_2023_lapsed_users = {
			"english": {header1:"Get 30% off any annual prepaid subscription",header2:"Use code: <span>T8FPHPCX</span>", header3: "", css:'', css_mobile: '',  use_code:"",cta:"Save now", disclaimer:"We use your information in accordance with our privacy policy."},
			...
			"hungary": {header1:"30% kedvezm\u00E9ny minden el\u0151re fizetett \u00E9ves el\u0151fizet\u00E9s \u00E1r\u00E1b\u00F3l",header2:"Haszn\u00E1lja a k\u00F6vetkez\u0151 k\u00F3dot: <span>T8FPHPCX</span>",header3: "", css:'', css_mobile: '', use_code:"",cta:"Most 30% kedvezm\u00E9nnyel", disclaimer:"Jogi nyilatkozat: Az adatait az adatv\u00E9delmi nyilatkozatunk el\u0151\u00EDr\u00E1sai szerint haszn\u00E1ljuk fel."},
			...
			"russia": {header1:"\u041F\u043E\u043B\u0443\u0447\u0438\u0442\u0435 \u0441\u043A\u0438\u0434\u043A\u0443 30 % \u043D\u0430 \u043F\u0440\u0435\u0434\u043E\u043F\u043B\u0430\u0447\u0435\u043D\u043D\u0443\u044E \u0433\u043E\u0434\u043E\u0432\u0443\u044E \u043F\u043E\u0434\u043F\u0438\u0441\u043A\u0443",header2:"\u0412\u043E\u0441\u043F\u043E\u043B\u044C\u0437\u0443\u0439\u0442\u0435\u0441\u044C \u043A\u043E\u0434\u043E\u043C: <span>T8FPHPCX</span>",header3: "", css:'', css_mobile: '', use_code:"",cta:"\u0412\u043E\u0441\u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u044C\u0441\u044F \u0441\u043A\u0438\u0434\u043A\u043E\u0439 ", disclaimer:"\u041E\u0442\u043A\u0430\u0437 \u043E\u0442 \u043E\u0442\u0432\u0435\u0442\u0441\u0442\u0432\u0435\u043D\u043D\u043E\u0441\u0442\u0438: \u041C\u044B \u0438\u0441\u043F\u043E\u043B\u044C\u0437\u0443\u0435\u043C \u0432\u0430\u0448\u0443 \u0438\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044E \u0432 \u0441\u043E\u043E\u0442\u0432\u0435\u0442\u0441\u0442\u0432\u0438\u0438 \u0441 \u043D\u0430\u0448\u0435\u0439 \u043F\u043E\u043B\u0438\u0442\u0438\u043A\u043E\u0439 \u043A\u043E\u043D\u0444\u0438\u0434\u0435\u043D\u0446\u0438\u0430\u043B\u044C\u043D\u043E\u0441\u0442\u0438."},
			"sweden": {header1:"F\u00E5 30 % rabatt p\u00E5 valfri f\u00F6rskottsbetald \u00E5rlig prenumeration",header2:"Anv\u00E4nd koden: <span>T8FPHPCX</span>",header3: "", css:'', css_mobile: '', use_code:"",cta:"Spara nu", disclaimer:"Observera: Vi anv\u00E4nder din information i enlighet med v\u00E5r integritetspolicy."},
			...
			"korean": {header1:"\uC5F0\uAC04 \uAD6C\uB3C5 \uC120\uBD88 \uC694\uAE08\uC744 30% \uD560\uC778\uBC1B\uC73C\uC138\uC694",header2:"\uCF54\uB4DC\uB97C \uC0AC\uC6A9\uD558\uC138\uC694: <span>T8FPHPCX</span>",header3: "", css:'', css_mobile: '', use_code:"",cta:"\uC9C0\uAE08 30% \uD560\uC778\uBC1B\uAE30", disclaimer:"\uBA74\uCC45 \uC870\uD56D: \uC6B0\uB9AC\uB294 \uAC1C\uC778\uC815\uBCF4 \uBCF4\uD638\uC815\uCC45\uC5D0 \uB530\uB77C \uADC0\uD558\uC758 \uC815\uBCF4\uB97C \uC0AC\uC6A9\uD569\uB2C8\uB2E4"},
			...
			"french": {header1:"B\u00E9n\u00E9ficiez de 30 % de r\u00E9duction sur tous les abonnements annuels pr\u00E9pay\u00E9s",header2:"Utilisez ce code : <span>T8FPHPCX</span>",header3: "", css:'', css_mobile: '', use_code:"",cta:"\u00C9conomisez Maintenant", disclaimer:"Disclaimer : Nous utilisons vos informations conform\u00E9ment \u00E0 notre politique de confidentialit\u00E9. "},
			...
			"german": {header1:"Erhalten Sie 30 % Rabatt bei einem j\u00E4hrlichen Abonnement mit Vorabzahlung",header2:"Verwenden Sie diesen Code: <span>T8FPHPCX</span>",header3: "", css:'', css_mobile: '', use_code:"",cta:"Jetzt sparen", disclaimer:"Disclaimer: Wir nutzen Ihre Informationen im Einklang mit unserer Datenschutzrichtlinie."},
			"dutch": {header1:"Krijg 30% korting op elk vooraf betaald jaarabonnement",header2:"Gebruik deze code: <span>T8FPHPCX</span>",header3: "", css:'', css_mobile: '', use_code:"",cta:"Bespaar nu", disclaimer:""},
			"japanese": {header1:"\u5E74\u9593\u5B9A\u984D\u30D7\u30E9\u30F3\uFF08\u524D\u6255\u3044\uFF09\u304C\u3059\u3079\u306630%\u30AA\u30D5",header2:"\u6B21\u306E\u30B3\u30FC\u30C9\u3092\u3054\u4F7F\u7528\u304F\u3060\u3055\u3044: <span>T8FPHPCX</span>", header3: "",css:'', css_mobile: '', use_code:"",cta:"\u4ECA\u306A\u308930%\u5272\u5F15", disclaimer:"\u514D\u8CAC\u4E8B\u9805\uFF1A\u5F53\u793E\u306F\u3001\u304A\u5BA2\u69D8\u306E\u60C5\u5831\u3092\u5F53\u793E\u306E\u30D7\u30E9\u30A4\u30D0\u30B7\u30FC\u30DD\u30EA\u30B7\u30FC\u306B\u57FA\u3065\u304D\u4F7F\u7528\u3057\u307E\u3059\u3002"},
